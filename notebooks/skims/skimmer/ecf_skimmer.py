...
if __name__ == "__main__":
    ...
    print(f"dumping {len(input_dict)} samples, type = {type(input_dict)}")
    with open('input_datasets.json', 'w') as fin:
        json.dump(input_dict, fin)
    ...
    to_skim = 'SingleMuon_Run2017B_240303_183047' ## Use this string to choose the subsample. Name must be found in input_datasets.json ######
    ...
    #print(f"shutdown {m.workers_shutdown()} workers")
